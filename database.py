...
# Sheet configuration
SHEET_ID = "1oI0bgt2gvK_wsvswFmYJxGiJYOhOJZVGwq_rH3RcljI"  # Replace with your Google Sheet ID
...
def load_products():
    products_sheet = get_worksheet('toysproducts')
    if products_sheet:
...
def load_orders():
    orders_sheet = get_worksheet('toysorders')
    if orders_sheet:
